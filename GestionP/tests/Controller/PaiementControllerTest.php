...
class PaiementControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'paiement[Amount]' => 'Testing',
            'paiement[PaiementDate]' => 'Testing',
            'paiement[M_id]' => 'Testing',
            'paiement[Description]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setPaiementDate('My Title');
        $fixture->setM_id('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'paiement[Amount]' => 'Something New',
            'paiement[PaiementDate]' => 'Something New',
            'paiement[M_id]' => 'Something New',
            'paiement[Description]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getPaiementDate());
        self::assertSame('Something New', $fixture[0]->getM_id());
