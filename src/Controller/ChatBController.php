...
class ChatBController extends AbstractController
{
    ...
    public function message(): Response
    {
        ...
        $botman->hears(
            'hi',
            function (BotMan $bot) {
                $bot->reply('Hello, I am a Chatbot of TICTACGO here to answer your questions , please dont hesitate to ask me anything !');
            }
        );
        ...
        $botman->hears(
            ...
            function (BotMan $bot) {
                ...
                $bot->reply('First name: ' . $bot->userStorage()->get('name'));
            }
        );
